package uk.gov.hmcts.reform.finrem.taskconfiguration.config;
...
public class OpenAPIConfiguration {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
            .info(new Info().title("finrem-task-configuration Service")
                      .version("v1.0.0")
                      .license(new License().name("MIT").url("https://opensource.org/licenses/MIT")))
            .externalDocs(new ExternalDocumentation()
                              .description("README")
                              .url("https://github.com/hmcts/finrem-task-configuration"));
    }
