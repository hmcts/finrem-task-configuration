...
class CamundaTaskCompletionConsentedTest extends DmnDecisionTableBaseUnitTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"FR_issueApplication","FR_awaitingInfo","FR_generalEmail",
        "FR_generalLetter","FR_generalOrderFromAwaitingInfo","FR_listForHearing","FR_close"})
    ...
    @Test
    void givenAssignToJudgeConsentEventShouldAutoCompleteReviewOrderResponseTask() {
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue("eventId", "FR_referToJudgeFromRespondToOrder");
