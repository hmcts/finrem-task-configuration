...
class CamundaTaskInitiationConsentedTest extends DmnDecisionTableBaseUnitTest {
    ...
    @ValueSource(strings = {
        ...
        "FR_caseSubmissionFromAwaitingInfo",
        "FR_caseSubmissionFromInfoReceived",
        "FR_paymentMadeFromHWF",
        "FR_paymenetMade",
    ...
    void givenCheckAndIssueApplicationTriggerEventIds_whenEvaluated_thenInitiatesCheckAndIssueApplicationTask(
        ...
        assertThat(dmnDecisionTableResult.getResultList())
            ...
            .isEqualTo(List.of(
                Map.of(
                    "taskId", "checkAndIssueApplication",
                    "name", "Check and Issue Application",
                    "delayDuration", 0,
                    "processCategories", "CHANGE_LATER_PROCESS_CATEGORIES"
                )
            ));
    ...
    void givenSubmitResponseEventReceivedWithValidPostEventStateCreatesCheckResponseReceivedTask() {
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue("eventId", "FR_uploadDocument");
